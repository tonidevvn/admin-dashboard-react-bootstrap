...
function Dashboard() {
  const [toogledSB, setToogledSB] = useState(false);
          ...
          >
            ...
            <div className="text-center d-none d-md-inline">
              <button
                ...
                id="sidebarToggle"
                onClick={() => setToogledSB(!toogledSB)}
              ></button>
            </div>
                            ...
                            <div className="row no-gutters align-items-center">
                              ...
                              <div className="col">
                                <div className="progress progress-sm mr-2">
                                  <div
                                    className="progress-bar bg-info w50"
                                    role="progressbar"
                                    aria-valuenow="50"
                                    aria-valuemin="0"
                                    aria-valuemax="100"
                    ...
                    <div className="card shadow mb-4">
                      ...
                      <div className="card-body">
                        ...
                        <div className="progress mb-4">
                          <div
                            className="progress-bar bg-danger w20"
                            role="progressbar"
                            aria-valuenow="20"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        ...
                        <div className="progress mb-4">
                          <div
                            className="progress-bar bg-warning w40"
                            role="progressbar"
                            aria-valuenow="40"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        ...
                        <div className="progress mb-4">
                          <div
                            className="progress-bar bg-info w80"
                            role="progressbar"
                            aria-valuenow="80"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        ...
                        <div className="progress">
                          <div
                            className="progress-bar bg-success w100"
                            role="progressbar"
                            aria-valuenow="100"
                            aria-valuemin="0"
                            aria-valuemax="100"
